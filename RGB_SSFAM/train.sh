...
if [ "$current_hostname" == "$expected_hostname" ]; then
    python train.py --train_data_dir=/root/autodl-tmp/dataset/polyp/train --val_data_dir=/root/autodl-tmp/dataset/polyp/test --checkpoint=/applications/graduate_design/model/finetuned/SSFam/best.pth --save_path=/applications/graduate_design/model/finetuned/SSFam/ --epoch=100 --val_dataset=overall --lr=5e-5 --batchsize=1 --freeze_image_encoder=False
else
